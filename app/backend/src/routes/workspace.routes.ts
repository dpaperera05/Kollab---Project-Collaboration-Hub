...
import { createTask, deleteTask, getWorkspace, getWorkspaceChat, sendWorkspaceMessage, updateTask } from "../controllers/workspace.controller";
...
router.get("/:projectId/chat", authenticate, getWorkspaceChat);
